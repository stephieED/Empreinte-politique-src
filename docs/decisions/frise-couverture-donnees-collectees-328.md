...
**Une seule encre, `--ink`, et une seule entrée de légende : « Données
collectées ».** La frise dit ce que le dépôt porte et depuis quand ; la fiche
d'origine n'y est plus un encodage. L'institution reste la hiérarchie, jamais
une couleur sur cette figure.
