...
| **EuroVoc** (Office des publications, point SPARQL) | les **libellés français** des concepts dont le portail EP donne l'identifiant. Rien n'est découvert ni classé ici (#901) | une requête `VALUES` par **100 concepts** — 4 libellés en 0,22 s au 16/09/2026. CC BY 4.0, attribution et indication des modifications. Un code sans libellé est **déclaré**, jamais inventé |
