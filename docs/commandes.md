...
python3 src/purge_interventions_nosdeputes.py --profiles-dir pivot_data/profiles
```
...
`purge_interventions_nosdeputes.py` se lance **deux fois, une fois par couche** :
