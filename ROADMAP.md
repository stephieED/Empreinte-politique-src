...
- Extra-parliamentary bodies matching — homonym risk, see
  `technical_decisions.md#hors-perimetre`.
- Syceron (comptes rendus de séance) AN open data — Phase 0 (structure XML + mapping pivot) documentée ; implémentation extracteur/interpréteur à planifier. Voir `docs/extract-syceron-an.md`.
