...
| **Filtre par intitulé (fiche candidat)** | **Une barre en pilule** sous l'en-tête de la fiche (`.cp-filtre`, #979) : un mot, et la fiche se recalcule sur ce que les intitulés portent. Tant qu'un mot est tapé, « En bref », « Les fonctions exercées » et « Ce qu'on n'a pas pu lire » se retirent, et **chaque figure porte en tête une étiquette** « Intitulés contenant « … » » (`.cp-filtre-etiquette`), le mot surligné sur le bas des lettres comme un titre de section — pour qu'une capture de la figure seule ne circule pas sans lui. Un mot sans résultat laisse la section en place avec une note du filtre (`.cp-filtre-vide`), jamais le « Non collecté » d'une collecte vide. Arbitré sur maquette le 17/09/2026 : `docs/decisions/filtre-par-intitule-fiche-candidat-979.md`. |
