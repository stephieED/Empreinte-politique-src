...
| **Frise de couverture (`/couverture`)** | **Un rail, une encre** (`.fc-rail` / `.fc-couche`, #328). Les faits portés par les fiches de candidats, de gouvernement et de groupe vivent dans le même rail, **sous une seule catégorie « Données collectées », dans la teinte de leur institution** — Assemblée prune, Gouvernement ocre, Parlement européen bleu de l'Union, les valeurs de la fiche candidat (tranché par la propriétaire le 11/09/2026) ; la fiche d'origine n'est plus encodée, le survol d'un segment la nomme encore. Le Parlement européen porte une hachure après la dernière date parue à sa source, que le pipeline déclare (#683) ; rien avant sa première donnée, qui n'est pas une borne. Deux absences, deux motifs, jamais confondus (§6 bis règle 7) — la **hachure pâle** dit « la source ne publie pas » (un fait sur l'institution, immuable), le **jaune hachuré à filet d'encre** dit « nous ne l'avons pas collecté » (un fait sur NOUS, et l'accent marque l'action dans ce système). |
